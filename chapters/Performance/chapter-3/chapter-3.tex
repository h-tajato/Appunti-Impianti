...
\begin{figure}[h]
\centering
\includegraphics[width=.8\textwidth]{img/Performance/chapter-3/CUS-SUT.png}
...
\centering
\includegraphics[width=\textwidth]{img/Performance/chapter-3/multi-histogram.png}
...
\begin{subfigure}[b]{0.8\textwidth}
\centering
\includegraphics[width=.8\textwidth]{img/Performance/chapter-3/multi-histogram-3d.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=.6\textwidth]{img/Performance/chapter-3/Clustering.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=.8\textwidth]{img/Performance/chapter-3/clustering-graph.png}
...
\begin{subfigure}[b]{0.8\textwidth}
\centering
\includegraphics[width=\textwidth]{img/Performance/chapter-3/single-linkage.png}
...
\begin{subfigure}[b]{0.8\textwidth}
\centering
\includegraphics[width=\textwidth]{img/Performance/chapter-3/complete-linkage.png}
...
\begin{subfigure}[b]{0.8\textwidth}
\centering
\includegraphics[width=\textwidth]{img/Performance/chapter-3/average-linkage.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=.8\textwidth]{img/Performance/chapter-3/dendogramma.png}
