...
Per capire quanto un fattore sia "importante", si va a considerare la variazine che avviene nella risposta a valle della variazione del fattore. Per comprendere al meglio come viene calcolata, si parte dalla varianza della variabile di risposta, calcolata come:
\[
...
\[
SST = \sum_{j=1}^{r}\sum_{i=1}^{2^k}(y_{ij} - \overline{y})^2
\]
...
\[
SSE = \sum_{j=1}^{r}\sum_{i=1}^{2^k}e_{ij}
\]
...
\[
SST = \sum_{j=1}^{r}\sum_{i=1}^{2^k}(y_{ij} - \overline{y})^2 =\sum_{j=1}^{r}\sum_{i=1}^{2^k}y_{ij}^2 + \sum_{j=1}^{r}\sum_{i=1}^{2^k}\overline{y}^2 - 2 \sum_{j=1}^{r}\sum_{i=1}^{2^k}y_{ij}\overline{y}
\]
Sapendo che:
\[SSY = \sum_{j=1}^{r}\sum_{i=1}^{2^k}y_{ij}\]
\[SS0 = \sum_{j=1}^{r}\sum_{i=1}^{2^k}\overline{y}^2 = r 2^k \overline{y}^2\]
