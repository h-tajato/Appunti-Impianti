...
\begin{figure}[h]
\centering
\includegraphics[width=.7\textwidth]{img/Performance/chapter-5/quality-regression.png}
...
\]
Questo però è un problema di minimizzazione vincolata, che quindi viene risolto in certi modi utilizzando varie tecniche. Noi utilizzeremo una tecnica pervenuta dall'esame di analisi 1, ovvero andremo a derivare la funzione quadrata e a porla uguale a 0. 
...
\begin{figure}[h]
\centering
\includegraphics[width=.7\textwidth]{img/Performance/chapter-5/regression-relations.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=.8\textwidth]{img/Performance/chapter-5/independet-errors.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=.7\textwidth]{img/Performance/chapter-5/errors-side-effect.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=.7\textwidth]{img/Performance/chapter-5/qqplot-errors.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=.7\textwidth]{img/Performance/chapter-5/constant-deviation.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=.7\textwidth]{img/Performance/chapter-5/concordant-discordant.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=.7\textwidth]{img/Performance/chapter-5/relazioni-curvilinee.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=.7\textwidth]{img/Performance/chapter-5/no-visualize.png}
